...
export default function HomePageClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-indigo-50/50">
      ...
      <section className="py-8 md:py-16 lg:py-24 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-900 mb-4">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto mb-6">
              Earn internationally recognized certificates and share your language learning journey with the world.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-3">Professional Recognition</h3>
                <p className="text-sm md:text-base text-gray-600">
                  Certificates recognized by educational institutions and employers worldwide.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-3">Global Community</h3>
                <p className="text-sm md:text-base text-gray-600">
                  Share your achievements with learners from around the world and inspire others.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-3">Privacy Control</h3>
                <p className="text-sm md:text-base text-gray-600">
                  Choose which certificates to make public and control your online presence.
                </p>
              </CardContent>
            </Card>
          </div>
