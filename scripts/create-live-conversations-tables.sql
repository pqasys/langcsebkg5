-- Create Live Conversation Tables
...
INSERT INTO `live_conversations` (
  `id`, `title`, `description`, `conversationType`, `language`, `level`, 
  `startTime`, `endTime`, `duration`, `maxParticipants`, `currentParticipants`,
  `price`, `isPublic`, `isFree`, `status`, `hostId`, `topic`
) VALUES 
(
  'conv-001', 
  'Beginner Spanish Conversation', 
  'Practice basic Spanish conversation skills with fellow beginners. We\'ll cover greetings, introductions, and everyday topics.',
  'GROUP', 
  'es', 
  'CEFR_A1', 
...
(
  ...
  'Improve your business English skills through role-playing exercises and professional discussions.',
  'PRACTICE', 
  'en', 
  'CEFR_B2', 
...
(
  ...
  'Learn about French culture while practicing your French language skills. We\'ll discuss traditions, food, and daily life.',
  'CULTURAL', 
  'fr', 
  'CEFR_B1', 
...
INSERT INTO `live_conversation_bookings` (
  `id`, `conversationId`, `userId`, `status`, `paymentStatus`, `amount`
) VALUES 
(
  'booking-001', 
  'conv-001', 
...
UPDATE `live_conversations` SET `currentParticipants` = 3 WHERE `id` = 'conv-001';
UPDATE `live_conversations` SET `currentParticipants` = 2 WHERE `id` = 'conv-002';
UPDATE `live_conversations` SET `currentParticipants` = 1 WHERE `id` = 'conv-003'; 