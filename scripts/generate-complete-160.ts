...
// Read the existing Spanish questions file to get A1, A2, B1 questions
const questionsPath = path.join(__dirname, '..', 'lib', 'data', 'spanish-proficiency-questions.ts');
const content = fs.readFileSync(questionsPath, 'utf8');

// Extract existing A1, A2, B1 questions using regex
...
const existingA1 = parseQuestions(a1Matches);
const existingA2 = parseQuestions(a2Matches);
const existingB1 = parseQuestions(b1Matches);

// Enhanced B2, C1, C2 questions
const enhancedQuestions = [
  // B2 Grammar (14 questions) - Already defined in the previous script
  {
    "id": "B2-G-1",
    "level": "B2",
...
const allQuestions = [...existingA1, ...existingA2, ...existingB1, ...enhancedQuestions];
