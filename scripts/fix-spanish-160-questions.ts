...
function generatePlaceholderQuestions() {
  ...
  // C2 Level (27 questions: 14 Grammar, 13 Vocabulary) - To reach exactly 160
  for (let i = 1; i <= 14; i++) {
    questions.push({
      "id": `C2-G-${i}`,
      "level": "C2",
...
console.log(`   B1: ${b1Count} questions`);
console.log(`   B2: ${b2Count} questions`);
console.log(`   C1: ${c1Count} questions`);
console.log(`   C2: ${c2Count} questions`);
