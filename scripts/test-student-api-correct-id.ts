...
async function testStudentAPICorrectId() {
  try {
    console.log('Testing student API with correct institution ID...');
    
    const studentId = '5b5fbd13-8776-4f96-ada9-091973974873';
    const correctInstitutionId = '42308252-a934-4eef-b663-37a7076bb177'; // The one where student is actually enrolled
    
    // Simulate the exact API logic with correct institution ID
    const session = {
      user: {
    ...
    console.log('\n=== API Response with Correct Institution ID ===');
    ...
    console.log('Bio:', studentDetails.bio || 'N/A');
    console.log('Native Language:', studentDetails.native_language || 'N/A');
    console.log('Social Visibility:', studentDetails.social_visibility || 'N/A');
    
    console.log('\n✅ API test with correct institution ID completed successfully!');
